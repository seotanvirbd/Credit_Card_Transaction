...
COPY cc_detail
FROM 'D:\Data Scientist\power bi\ridhbah mishra\csv_sql_powerbi_project\csv_files\credit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\Data Scientist\power bi\ridhbah mishra\csv_sql_powerbi_project\csv_files\customer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'D:\Data Scientist\power bi\ridhbah mishra\csv_sql_powerbi_project\csv_files\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'D:\Data Scientist\power bi\ridhbah mishra\csv_sql_powerbi_project\csv_files\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
